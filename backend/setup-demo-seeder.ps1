...
Write-Host "Menulis DemoSeeder realistis kampus..." -ForegroundColor Cyan
...
'@ | Set-Content -Path "database\seeders\DemoSeeder.php" -Encoding ascii

Write-Host "Update DatabaseSeeder..." -ForegroundColor Cyan
...
Write-Host ""
Write-Host "SELESAI. DemoSeeder kampus realistis siap." -ForegroundColor Green
Write-Host "Jalankan: php artisan migrate:fresh --seed" -ForegroundColor Yellow